...
lvim.keys.normal_mode["<C-S>"] = ":wa"
lvim.keys.normal_mode["<C-n"] = ":enew"
lvim.keys.normal_mode["<leader>ui"] = ":TroubleToggle<CR>"
lvim.keys.normal_mode["<C-t><C-y>"] = ":wq"
lvim.keys.normal_mode["<C-t><C-t>"] = "q!"
lvim.keys.normal_mode["<C-T><C-Y>"] = "wqa"
lvim.keys.normal_mode["<C-T><C-T>"] = "qa"
lvim.keys.normal_mode["<leader>fs"] = ":lua require('telescope').extensions.live_grep_args.live_grep_args()<CR>"
...
-- vim.builtin.telescope.defaults.mappings = {
--   -- for input mode
--   i = {
...
formatters.setup {
  ...
  { command = "isort", filetypes = { "python" } },
  {
    ...
    filetypes = { "typescript", "typescriptreact", "rust", "cs", "html", "css", "scss" },
  },
}
